      ...
      {[
        {
          ...
          description:
            'We guide early-stage startups through building scalable, high-performance web applications that fuel business growth.',
          link: '/portfolio',
        },
        {
          ...
          description:
            'We focus on building fast, mobile-first, and highly scalable applications using the latest technologies to meet business needs.',
          link: '/services',
        },
        {
          ...
          description:
            'We work closely with you to understand your vision, applying data-driven strategies and modern frameworks to achieve results.',
          link: '/about',
        },
