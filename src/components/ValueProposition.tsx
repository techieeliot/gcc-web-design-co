...
export default function ValueProposition() {
  const benefits = [
    ...
    },
    {
      ...
      description:
        'Expertise in React, Next.js, and the latest web technologies for optimal performance.',
      icon: Code2,
    },
    {
      title: 'Collaborative Approach',
      description:
        'Direct communication and agile development to keep you involved every step of the way.',
      icon: Users,
    },
    {
