import { Binary, BookOpen, BriefcaseBusiness, CircuitBoard, Code2, Gavel, HandHeart, Heart, Leaf, Scale, Sprout, Star, TreePine, Users } from "lucide-react";
...
export default function ProjectShowcase() {
    ...
    return (
        <div className="w-full lg:col-span-4 bg-white rounded-lg shadow-md p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Recent Projects</h3>
            ...
            <div className="mt-3 space-y-2">
                <div className="border-t pt-2">
                    <p className="text-gray-600 text-xs">
                        Our portfolio showcases a diverse range of projects, from legal tech solutions 
                ...
                <div className="bg-gray-50 p-2 rounded-lg">
                    ...
                    <blockquote className="text-xs text-gray-700 italic">
                        "Working with devSouth transformed our digital presence and exceeded our expectations."
                    </blockquote>
