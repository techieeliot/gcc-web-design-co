            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <section>
                    ...
                    <p className="text-gray-600 mb-6">
                        Have a project in mind or questions for us? Reach out today and let's discuss how we can help your business grow.
                    </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:devsouth.us@gmail.com" className="text-gray-600 hover:text-blue-600">
    ...
    return(
        <article>
            ...
            <p className="text-gray-600 mb-8">
                Whether you need technical consulting, web development, or emergency support, 
