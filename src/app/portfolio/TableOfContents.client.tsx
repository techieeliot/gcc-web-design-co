...
export const TableOfContents = ({ className = '' }) => {
    ...
    const sections = [
        { id: 'fourthparty', title: 'FourthParty.app', subsections: ['Challenge', 'Solution', 'Impact', 'Results'] },
        { id: 'weedwarriors', title: 'Weed Warriors', subsections: ['Features', 'Impact', 'Technologies'] },
        { id: 'gorillafund', title: 'Gorilla Fund', subsections: ['Challenge', 'Scope', 'Impact', 'Contributions'] },
        { id: 'daretoshare', title: 'Dare to Share', subsections: ['Emergency Solutions', 'Response Metrics'] },
        { id: 'roominnmemphis', title: 'Room in the Inn', subsections: ['Weekend Sprint', 'Project Impact', 'Key Contributions'] }
    ]
